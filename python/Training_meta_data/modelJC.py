...
class Classifier(nn.Module):
    """
    Class for the Classifier model that uses a EfficientNet encoder and optional drop out.
    """

    def __init__(self, b=0, drop_rate=0.5):
        """
        ...
        # Sets the drop rate for the optional dropout layer.
...
class SelectiveNet(nn.Module):
    ...
    def __init__(self, b=0, drop_rate=0.5):
        ...
        self.selective_hidden = nn.Linear(1280, 512)
        ...
        self.auxiliary_output = nn.Linear(1280, 2)
